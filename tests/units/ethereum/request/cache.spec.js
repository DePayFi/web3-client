...
describe('request cache on ethereum', () => {
  ...
  it('serves responses made in parallel for various requests correctly on ethereum', async ()=> {
    ...
    let decimalMock1 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0x6b175474e89094c44da98b954eedeac495271d0f', api: Token['ethereum'].DEFAULT, method: 'decimals', return: '18' } })
    let decimalMock2 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0xdac17f958d2ee523a2206206994597c13d831ec7', api: Token['ethereum'].DEFAULT, method: 'decimals', return: '6' } })
    let decimalMock3 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0xa0bEd124a09ac2Bd941b10349d8d224fe3c955eb', api: Token['ethereum'].DEFAULT, method: 'decimals', return: '18' } })
    let decimalMock4 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0x3ab100442484dc2414aa75b2952a0a6f03f8abfd', api: Token['ethereum'].DEFAULT, method: 'decimals', return: '8' } })
  ...
  it('serves responses correctly even if some of them fail', async ()=>{
    ...
    let decimalMock1 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0x6b175474e89094c44da98b954eedeac495271d0f', api: Token['ethereum'].DEFAULT, method: 'decimals', return: Error('something went wrong') } })
    let decimalMock2 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0xdac17f958d2ee523a2206206994597c13d831ec7', api: Token['ethereum'].DEFAULT, method: 'decimals', return: '6' } })
