  ...
  ['ethereum', 'bsc'].forEach((blockchain)=>{
    ...
    describe(blockchain, ()=> {
      ...
      it('serves responses made in parallel for various requests correctly', async ()=> {
        ...
        let decimalMock1 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0x6b175474e89094c44da98b954eedeac495271d0f', api: ERC20, method: 'decimals', return: '18' } })
        let decimalMock2 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0xdac17f958d2ee523a2206206994597c13d831ec7', api: ERC20, method: 'decimals', return: '6' } })
        let decimalMock3 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0xa0bEd124a09ac2Bd941b10349d8d224fe3c955eb', api: ERC20, method: 'decimals', return: '18' } })
        let decimalMock4 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0x3ab100442484dc2414aa75b2952a0a6f03f8abfd', api: ERC20, method: 'decimals', return: '8' } })

        let decimals = await Promise.all([
          request({ blockchain: 'ethereum', address: '0x6b175474e89094c44da98b954eedeac495271d0f', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
          request({ blockchain: 'ethereum', address: '0xdac17f958d2ee523a2206206994597c13d831ec7', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
          request({ blockchain: 'ethereum', address: '0x6b175474e89094c44da98b954eedeac495271d0f', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
          request({ blockchain: 'ethereum', address: '0xdac17f958d2ee523a2206206994597c13d831ec7', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
          request({ blockchain: 'ethereum', address: '0x6b175474e89094c44da98b954eedeac495271d0f', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
          request({ blockchain: 'ethereum', address: '0xa0bEd124a09ac2Bd941b10349d8d224fe3c955eb', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
          request({ blockchain: 'ethereum', address: '0x3ab100442484dc2414aa75b2952a0a6f03f8abfd', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
          request({ blockchain: 'ethereum', address: '0xa0bEd124a09ac2Bd941b10349d8d224fe3c955eb', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
          request({ blockchain: 'ethereum', address: '0x3ab100442484dc2414aa75b2952a0a6f03f8abfd', method: 'decimals' },{ api: ERC20, cache: 86400000 }),
        ])
      ...
      it('serves responses correctly even if some of them fail', async ()=>{
        ...
        let decimalMock1 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0x6b175474e89094c44da98b954eedeac495271d0f', api: ERC20, method: 'decimals', return: Error('something went wrong') } })
        let decimalMock2 = mock({ provider: provider('ethereum'), blockchain: 'ethereum', call: { to: '0xdac17f958d2ee523a2206206994597c13d831ec7', api: ERC20, method: 'decimals', return: '6' } })

        request({ blockchain: 'ethereum', address: '0x6b175474e89094c44da98b954eedeac495271d0f', method: 'decimals' },{ api: ERC20, cache: 86400000 })
          .then(()=>{})
          .catch(()=>{})
        await request({ blockchain: 'ethereum', address: '0xdac17f958d2ee523a2206206994597c13d831ec7', method: 'decimals' },{ api: ERC20, cache: 86400000 })
      })
