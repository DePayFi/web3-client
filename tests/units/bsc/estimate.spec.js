...
describe('estimate transactions on bsc', () => {
  ...
  it('allows you to estimate transactions on bsc', async ()=> {
    ...
    let cost = await estimate('bsc://0xae60aC8e69414C2Dc362D0e6a03af643d1D85b92/route', {
      api,
      params: {
        path: ['0x1cBb83EbcD552D5EBf8131eF8c9CD9d9BAB342bC'],
        amounts: ['160000000000000000', '160000000000000000', '1626096776'],
  ...
  it('rejects the promise in case the transaction is not possible with a reason on bsc', async ()=> {
    ...
    await expect(
      estimate('bsc://0xae60aC8e69414C2Dc362D0e6a03af643d1D85b92/route', {
        api,
        params: {
          path: ['0x1cBb83EbcD552D5EBf8131eF8c9CD9d9BAB342bC'],
          amounts: ['160000000000000000', '160000000000000000', '1626096776'],
  ...
  it('rejects the promise in case no wallet is connected on bsc', async ()=> {
    await expect(
      estimate('bsc://0xae60aC8e69414C2Dc362D0e6a03af643d1D85b92/route', {
        api,
        params: {
  ...
  it('allows you to estimate transactions also with deconstructed URL on bsc', async ()=> {
