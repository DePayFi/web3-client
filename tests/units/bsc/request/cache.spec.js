...
describe('request cache on bsc', () => {
  ...
  let doRequestWithCache = async function(){
    return await request('bsc://0x7a250d5630b4cf539739df2c5dacb4c659f2488d/getAmountsOut', {
      cache: 1000,
      api: api,
      params: {
  ...
  it('it serves responses made in parallel from the same response promise lock on bsc', async ()=> {
  ...
  it('serves responses made in parallel for various requests correctly on bsc', async ()=> {
    ...
    let decimalMock1 = mock({ provider: provider('bsc'), blockchain: 'bsc', call: { to: '0x6b175474e89094c44da98b954eedeac495271d0f', api: Token['bsc'].DEFAULT, method: 'decimals', return: '18' } })
    let decimalMock2 = mock({ provider: provider('bsc'), blockchain: 'bsc', call: { to: '0xdac17f958d2ee523a2206206994597c13d831ec7', api: Token['bsc'].DEFAULT, method: 'decimals', return: '6' } })
    let decimalMock3 = mock({ provider: provider('bsc'), blockchain: 'bsc', call: { to: '0xa0bEd124a09ac2Bd941b10349d8d224fe3c955eb', api: Token['bsc'].DEFAULT, method: 'decimals', return: '18' } })
    let decimalMock4 = mock({ provider: provider('bsc'), blockchain: 'bsc', call: { to: '0x3ab100442484dc2414aa75b2952a0a6f03f8abfd', api: Token['bsc'].DEFAULT, method: 'decimals', return: '8' } })
  ...
  it('serves responses correctly even if some of them fail', async ()=>{
    ...
    let decimalMock1 = mock({ provider: provider('bsc'), blockchain: 'bsc', call: { to: '0x6b175474e89094c44da98b954eedeac495271d0f', api: Token['bsc'].DEFAULT, method: 'decimals', return: Error('something went wrong') } })
    let decimalMock2 = mock({ provider: provider('bsc'), blockchain: 'bsc', call: { to: '0xdac17f958d2ee523a2206206994597c13d831ec7', api: Token['bsc'].DEFAULT, method: 'decimals', return: '6' } })

    request({ blockchain: 'bsc', address: '0x6b175474e89094c44da98b954eedeac495271d0f', method: 'decimals' },{ api: Token['bsc'].DEFAULT, cache: 86400000 })
      .then(()=>{})
      .catch(()=>{})
    await request({ blockchain: 'bsc', address: '0xdac17f958d2ee523a2206206994597c13d831ec7', method: 'decimals' },{ api: Token['bsc'].DEFAULT, cache: 86400000 })
  })
