(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@depay/solana-web3.js')) :
  typeof define === 'function' && define.amd ? define(['exports', '@depay/solana-web3.js'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Web3Client = {}, global.SolanaWeb3js));
})(this, (function (exports, solanaWeb3_js) { 'use strict';
  ...
  const getProvider = async (blockchain)=>{
    ...
    if(supported.evm.includes(blockchain)) ; else if(supported.solana.includes(blockchain)) ; else {
  ...
  */
  ...
  var estimateEVM = ({ provider, from, to, value, method, api, params }) => {
    if(typeof api == "undefined"){
      ...
      let contract = new Contract(to, api, provider);
